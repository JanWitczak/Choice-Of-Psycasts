...
namespace ChoiceOfPsycasts
{
	...
	[HarmonyPatch(typeof(PawnUtility), "ChangePsylinkLevel")]
	...
	{
		static void Prefix(ref Pawn user, RimWorld.CompUseEffect_InstallImplant __instance)
		{
		...
		static void Postfix(ref Pawn user, RimWorld.CompUseEffect_InstallImplant __instance)
		{
